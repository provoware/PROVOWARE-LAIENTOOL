...
| I33 Offline-Wheelhouse Lock | `tests/test_i33_wheelhouse_lock.py` + Portable-Package-Gate; exakte Dateiliste/Größe/SHA-256 vor Build, nach Extraktion und vor lokaler Installation |
